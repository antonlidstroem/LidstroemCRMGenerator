# create-sln.ps1
# Windows equivalent of create-sln.sh
# Run once from the lidstroem\ directory in PowerShell:
#   .\create-sln.ps1
#
...
Write-Host ""
Write-Host "=========================================="
Write-Host " Lidstroem — Creating solution file"
Write-Host "=========================================="
Write-Host ""
...
Write-Host ""
Write-Host "Solution created: Lidstroem.sln"
Write-Host "Open with:  start Lidstroem.sln"
Write-Host ""
